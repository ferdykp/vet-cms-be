...
$__newAttributes = [];
$__propNames = \Illuminate\View\ComponentAttributeBag::extractPropNames((['name' => 'file']));
...
foreach (array_filter((['name' => 'file']), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
}
...
?>
<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" focusable="false" <?php echo e($attributes->class(['inline-block size-5 shrink-0 align-middle'])); ?>><path d="<?php echo e($paths[$name] ?? $paths['file']); ?>" /></svg>
<?php /**PATH /Users/ferdy/project-fl/vet-cms/backend/resources/views/components/icon.blade.php ENDPATH**/ ?>