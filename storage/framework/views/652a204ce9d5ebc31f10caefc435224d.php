...
- This project uses PHPUnit. Create tests with ___SINGLE_BACKTICK___<?php echo e($assist->artisanCommand('make:test --phpunit {name}')); ?>___SINGLE_BACKTICK___.
...
- Run ___SINGLE_BACKTICK___<?php echo e($assist->binCommand('phpunit')); ?>___SINGLE_BACKTICK___ to call the test runner directly. It accepts the same file path and ___SINGLE_BACKTICK___--filter=testName___SINGLE_BACKTICK___ arguments.
___SCOPED_END___
<?php /**PATH /Users/ferdy/project-fl/vet-cms/backend/storage/framework/views/8cdf590822423b871bed5be8c4a6ec59.blade.php ENDPATH**/ ?>