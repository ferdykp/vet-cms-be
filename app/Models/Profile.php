...
class Profile extends Model
{
    ...
    protected $fillable = ['user_id', 'profile_photo_id', 'hero_photo_id', 'full_name', 'short_name', 'professional_title', 'headline', 'short_bio', 'biography', 'email', 'phone', 'location', 'clinical_interests', 'social_links'];
