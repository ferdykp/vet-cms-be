...
<form class="flex h-10 items-center rounded-lg border border-[#DDE2DF] bg-white px-3" method="GET"><span class="text-[#5B675E]"><x-icon name="search" /></span><input class="w-48 border-0 bg-transparent px-2 text-sm outline-none" name="search" value="{{ request('search') }}" placeholder="Search tags"></form></section>
